...
**Status:** accepted (phases 2 to 4 amended by [ADR-0010](0010-us-market-positioning-and-ai-phases.md); real-AWS milestone deferred by [ADR-0012](0012-local-first-real-aws-deferred.md); push-based CD superseded by [ADR-0013](0013-gitops-with-argo-cd-on-long-lived-aws.md))
**Date:** 2026-09-20
